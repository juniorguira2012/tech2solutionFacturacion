...
const UnidadesSection = ({ mostrarToast, permisos }) => {
  // 🛡️ Extraemos los permisos específicos para esta sección
  const permisosUnidades = permisos?.subModulos?.unidades ?? permisos;
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-4">
      ...
      <div className="space-y-2 mt-4">
        ...
        {editingUnidadId === 'new' && permisosUnidades?.create && (
