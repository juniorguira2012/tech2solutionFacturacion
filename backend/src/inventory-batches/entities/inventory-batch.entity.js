...
var product_entity_1 = require("../../products/entities/product.entity"); // ⚠️ Revisa que la ruta a tu entidad de Producto sea correcta
var InventoryBatch = function () {
    ...
    var InventoryBatch = _classThis = /** @class */ (function () {
        function InventoryBatch_1() {
            ...
            this.numeroLote = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _numeroLote_initializers, void 0));
            ...
            this.producto = (__runInitializers(this, _fechaVencimiento_extraInitializers), __runInitializers(this, _producto_initializers, void 0));
            // Se queda exactamente igual, apuntando al mismo nombre físico
            // @Column({ name: 'producto_id' })
            // productoId: number;
            // Métricas de auditoría automáticas
            this.createdAt = (__runInitializers(this, _producto_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _numeroLote_decorators = [(0, class_transformer_1.Expose)({ name: 'lote' }), (0, typeorm_1.Column)({ name: 'numero_lote', type: 'varchar', length: 100, nullable: true, default: 'Sin Lote' })];
        _cantidad_decorators = [(0, typeorm_1.Column)({ type: 'int', default: 0 })];
        _almacen_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 150, default: 'Principal' })];
        _fechaVencimiento_decorators = [(0, typeorm_1.Column)({ name: 'fecha_vencimiento', type: 'date', nullable: true })];
        _producto_decorators = [(0, typeorm_1.ManyToOne)(function () { return product_entity_1.Product; }, { onDelete: 'CASCADE' }), (0, typeorm_1.JoinColumn)({ name: 'producto_id' })];
