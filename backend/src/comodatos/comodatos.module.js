...
var comodato_entity_1 = require("./entities/comodato.entity");
var product_entity_1 = require("../products/entities/product.entity");
var comodatos_service_1 = require("./comodatos.service");
var comodatos_controller_1 = require("./comodatos.controller");
var providers_module_1 = require("../providers/providers.module");
var ComodatosModule = function () {
    ...
    var _classThis;
    var ComodatosModule = _classThis = /** @class */ (function () {
        function ComodatosModule_1() {
        }
        return ComodatosModule_1;
    }());
    __setFunctionName(_classThis, "ComodatosModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ComodatosModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ComodatosModule = _classThis;
}();
