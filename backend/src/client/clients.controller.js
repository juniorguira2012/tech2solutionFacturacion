...
var ClientsController = function () {
    var _classDecorators = [(0, common_1.Controller)('clients')];
    ...
    var ClientsController = _classThis = /** @class */ (function () {
        ...
        ClientsController_1.prototype.create = function (clientData) {
            return this.clientsService.create(clientData);
        };
        ClientsController_1.prototype.update = function (id, clientData) {
