...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.create = function (createUserDto, role) {
            if (role !== 'admin')
                throw new common_1.UnauthorizedException('Solo el administrador puede crear usuarios');
            return this.usersService.create(createUserDto);
        };
        UsersController_1.prototype.update = function (id, updateUserDto, role) {
            if (role !== 'admin')
                throw new common_1.UnauthorizedException('Solo el administrador puede editar usuarios');
            return this.usersService.update(id, updateUserDto);
        };
        UsersController_1.prototype.remove = function (id, requestorId, role) {
            return __awaiter(this, void 0, void 0, function () {
                var targetUser, requestor, SUPER_USER_EMAIL;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.usersService.findOne(Number(requestorId))];
                        case 2:
                            requestor = _a.sent();
                            if (!requestor)
                                throw new common_1.UnauthorizedException('Solicitante no válido');
                            SUPER_USER_EMAIL = 'techtwosolution2@gmail.com';
                            if (targetUser.rol === 'admin' && requestor.email !== SUPER_USER_EMAIL) {
                                throw new common_1.UnauthorizedException("Solo el super usuario ".concat(SUPER_USER_EMAIL, " puede desactivar administradores"));
                            }
