...
var EmailService = function () {
    ...
    var EmailService = _classThis = /** @class */ (function () {
        ...
        EmailService_1.prototype.sendMail = function (to, subject, html) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            info = _a.sent();
                            common_1.Logger.log("Correo enviado a ".concat(to, ": ").concat(info.messageId), EmailService.name);
                            return [2 /*return*/, info];
                        case 2:
                            error_1 = _a.sent();
                            common_1.Logger.error("Error enviando correo a ".concat(to), error_1, EmailService.name);
                            throw error_1;
        ...
        EmailService_1.prototype.sendResetPasswordEmail = function (to, resetUrl) {
            return __awaiter(this, void 0, void 0, function () {
                var subject, html;
                return __generator(this, function (_a) {
                    subject = 'Restablecer contraseña';
                    html = "<p>Hola,</p>\n      <p>Haz clic en el siguiente enlace para restablecer tu contrase\u00F1a:</p>\n      <p><a href=\"".concat(resetUrl, "\">").concat(resetUrl, "</a></p>\n      <p>Si no solicitaste este cambio, ignora este correo.</p>");
                    return [2 /*return*/, this.sendMail(to, subject, html)];
                });
            });
        };
