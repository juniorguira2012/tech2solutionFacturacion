...
var RolesController = function () {
    ...
    var RolesController = _classThis = /** @class */ (function () {
        ...
        RolesController_1.prototype.getRoles = function () {
        ...
        RolesController_1.prototype.updateConfig = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.rolesService.updateConfig(body.name, body.config)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _getRoles_decorators = [(0, common_1.Get)()];
        _updateConfig_decorators = [(0, common_1.Post)('update-config')];
