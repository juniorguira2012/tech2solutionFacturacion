...
var RolesService = function () {
    ...
    var RolesService = _classThis = /** @class */ (function () {
        function RolesService_1(roleRepository) {
        ...
        RolesService_1.prototype.updateConfig = function (name, config) {
            return __awaiter(this, void 0, void 0, function () {
                var role;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            role = _a.sent();
                            if (!role) {
                                role = this.roleRepository.create({ name: name, config: config });
                            }
                            else {
                                role.config = config;
                            }
