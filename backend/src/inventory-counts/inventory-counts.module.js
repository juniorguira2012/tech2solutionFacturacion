...
var inventory_counts_service_1 = require("./inventory-counts.service");
var inventory_counts_controller_1 = require("./inventory-counts.controller");
var inventory_count_entity_1 = require("./entities/inventory-count.entity");
var count_item_entity_1 = require("./entities/count-item.entity");
var product_entity_1 = require("../products/entities/product.entity");
var audit_log_entity_1 = require("./entities/audit-log.entity");
var InventoryCountsModule = function () {
    ...
    var _classThis;
    var InventoryCountsModule = _classThis = /** @class */ (function () {
        function InventoryCountsModule_1() {
        }
        return InventoryCountsModule_1;
    }());
    __setFunctionName(_classThis, "InventoryCountsModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        InventoryCountsModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return InventoryCountsModule = _classThis;
}();
