...
var product_serials_service_1 = require("./product-serials.service");
var product_serials_controller_1 = require("./product-serials.controller");
var product_entity_1 = require("./entities/product.entity");
var ProductSerialsModule = function () {
    ...
    var _classThis;
    var ProductSerialsModule = _classThis = /** @class */ (function () {
        function ProductSerialsModule_1() {
        }
        return ProductSerialsModule_1;
    }());
    __setFunctionName(_classThis, "ProductSerialsModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ProductSerialsModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductSerialsModule = _classThis;
}();
