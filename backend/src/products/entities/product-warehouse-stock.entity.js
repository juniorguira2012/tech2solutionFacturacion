...
var ProductWarehouseStock = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('product_warehouse_stock'), (0, typeorm_1.Unique)(['productoId', 'almacen'])];
    ...
    var ProductWarehouseStock = _classThis = /** @class */ (function () {
        function ProductWarehouseStock_1() {
            ...
            this.almacen = (__runInitializers(this, _productoId_extraInitializers), __runInitializers(this, _almacen_initializers, void 0));
            this.cantidad = (__runInitializers(this, _almacen_extraInitializers), __runInitializers(this, _cantidad_initializers, void 0));
            this.producto = (__runInitializers(this, _cantidad_extraInitializers), __runInitializers(this, _producto_initializers, void 0));
            __runInitializers(this, _producto_extraInitializers);
        }
        return ProductWarehouseStock_1;
    }());
    __setFunctionName(_classThis, "ProductWarehouseStock");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _productoId_decorators = [(0, typeorm_1.Column)()];
        _almacen_decorators = [(0, typeorm_1.Column)()];
        _cantidad_decorators = [(0, typeorm_1.Column)('int', { default: 0 })];
        _producto_decorators = [(0, typeorm_1.ManyToOne)(function () { return product_entity_1.Product; }, function (product) { return product.warehouseStocks; }, { onDelete: 'CASCADE' }), (0, typeorm_1.JoinColumn)({ name: 'productoId' })];
        ...
        ProductWarehouseStock = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductWarehouseStock = _classThis;
}();
